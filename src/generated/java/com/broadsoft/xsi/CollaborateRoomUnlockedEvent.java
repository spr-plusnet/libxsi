 ...
 *       
 * 
 * <p>Java-Klasse für CollaborateRoomUnlockedEvent complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="CollaborateRoomUnlockedEvent">
 *   &lt;complexContent>
...
@XmlType(name = "CollaborateRoomUnlockedEvent", propOrder = {
    "collaborateRoomParticipant"
})
public class CollaborateRoomUnlockedEvent
    extends EventData
{
